...
import "../App.js";
import "../chatbot.css";
import Scott from "../res/scotialogo.png";
...
export class Chatbot extends React.Component{
    ...
    addChatbotClose(){
        console.log("chatbot closed added");
    }
    render() {
        return (
            <div id="chatbot" className="opened">
                <div className="title-bar">
                    <a id="title"><strong>Scott</strong></a>
                    <div id="minimize" onClick={this.addChatbotClose()}></div>
                </div>
                <main id="main">
                    <div id="lastAvatar" className="avatar"><img src={ Scott } style={{ width:25, height:25 }} className="center" /></div>
                    <div className="message left" id="bot"><span id="bot-response">Hi, this is the Scotiabank Assistant. How may I help you today?</span></div>
                </main>
                <div id="user-bar">
                        <div>
                            <input id="input" type="text" placeholder="Ask us anything"></input>
                        </div>
                        <div id="speak"> <Mic /> </div>
